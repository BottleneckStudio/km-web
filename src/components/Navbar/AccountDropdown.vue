<template>
  <div class="relative">
    ...
    <button v-if="isOpen" @click="isOpen = false" tabindex="-1" class="fixed inset-0 h-full w-full opacity-50 cursor-default"></button>
    <div v-if="isOpen" class="absolute right-0 mt-1 py-1 w-48 bg-white rounded-lg shadow-xl">
      ...
      <a href="#" @click="signout()" class="block px-4 py-2 text-gray-800 hover:bg-indigo-500 hover:text-white">Sign out</a>
    </div>
  </div>
</template>
