<template>
  <div class="flex flex-col items-center justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
    <sign-in :toggle="toggle" v-if="formState === 'signIn'"></sign-in>
